...
def predict_placement(data: StudentData):
    # This is where your AI 'Math' will go later this all use a swagger ui we need to add /docs in our link for ui. and we will use that ui to test our api and then we will use that data to predict the price of the product.
